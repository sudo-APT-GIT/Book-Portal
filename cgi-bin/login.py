...
conn=sqlite3.connect('passwords1.db')

#conn.execute("CREATE TABLE pwdTable (username VARCHAR PRIMARY KEY, password VARCHAR);")
#conn.execute("INSERT INTO pwdTable VALUES('prithvi', 'patti18');")
#conn.execute("INSERT INTO pwdTable VALUES('varsha', 'achhu23');")
#conn.execute("INSERT INTO pwdTable VALUES('anusha', 'anuu28');")
#conn.execute("INSERT INTO pwdTable VALUES('sumi', 'sumi18');")
